...
export default function Store({ onAddToCart, cartOpenSignal, genderFilter = 'all' }) {
  ...
  const toggleFavorite = async (product, e) => {
    ...
    try {
      await toggleFavoriteDb(product.id, sessionId, isFav);
    } catch {}
  };
  ...
  return (
    <div style={{ color: 'var(--text-primary)' }}>
        ...
        <div>
          ...
          <style dangerouslySetInnerHTML={{
            ...
            @media (max-width: 768px) {
              ...
              .cart-panel { border-radius: 20px 20px 0 0 !important; max-width: 100% !important; max-height: 88vh !important; }
              .cart-panel::before { content: ''; display: block; flex-shrink: 0; width: 40px; height: 4px; background: rgba(255,255,255,0.18); border-radius: 2px; margin: 0.75rem auto 0.5rem; }
              /* ── Reviews carousel ── */
              .reviews-grid { display: flex !important; overflow-x: auto; scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch; scrollbar-width: none; -ms-overflow-style: none; padding-bottom: 1rem; gap: 0.75rem !important; margin-bottom: 1.5rem !important; }
      ...
      <div id="testimonios" style={{ marginTop: '3.5rem', marginBottom: '2rem', scrollMarginTop: '90px' }}>
        ...
        {/* Grilla de reseñas */}
        <div className="reviews-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
          {reviews.map(review => (
